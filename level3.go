...
func (l Level3) Init() {
	...
	g.temp_tfa = newTFA("act_TFA.png", newRect(400, -100, 150, 150), "tfa2")
...
func (l Level3) Update(g *Game) {
	...
	g.temp_tfa.activate()
	g.temp_tfa.update()
	l.rnaPolymerase.update(g.temp_tfa.rect.pos.y)
	if l.reset {
	...
	l.dna[l.currentFrag].is_complete = l.rightChoice.update1(g, l.dna[l.currentFrag].codon)
	//fmt.Printf("%t\n", dna[currentFrag].is_complete)
