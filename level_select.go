...
func newLevelSelection(g *Game) {
	g.stateMachine.state = LevelSelection{
		levToPlasmaButton:  newButton("levToPlasmaBtn.png", newRect(400, 125, 232, 129), ToLevel1),
		levToCyto1Button:   newButton("levToCyto1Btn.png", newRect(750, 125, 232, 129), ToLevel2),
		levToNucleusButton: newButton("levToNucleusBtn.png", newRect(400, 250, 232, 129), ToLevel3),
		levToCyto2Button:   newButton("levToCyto2Btn.png", newRect(750, 250, 232, 129), ToLevel4),
...
func (l LevelSelection) Update(g *Game) {
	...
	l.levToPlasmaButton.on_click(g)
	l.levToCyto1Button.on_click(g)
	l.levToNucleusButton.on_click(g)
	l.levToCyto2Button.on_click(g)
	l.levToMenuButton.on_click(g)
}
